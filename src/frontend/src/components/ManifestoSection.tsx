...
const manifestoCategories: ManifestoCategory[] = [
  ...
  },
  {
    ...
    icon: "🚀",
    image: "/assets/generated/manifesto-entrepreneurship.dim_800x500.jpg",
    points: [
      "PEP will actively promote entrepreneurship among youth by providing structured government support, financial assistance, and mentorship to help aspiring entrepreneurs establish and grow their businesses.",
      "Government EMI Scheme for Business: Citizens wishing to start or expand a business will be eligible for government-backed EMI (Equated Monthly Instalment) loans at low interest rates, making business ownership accessible to all — including those from economically weaker backgrounds.",
      "Startup Incubation Centers: Dedicated incubation centers will be established to provide workspace, mentorship, legal guidance, and market access to new entrepreneurs.",
      "Business Registration Simplified: The process of registering a new business will be made faster, more transparent, and digitally accessible through a single-window online system.",
      "Support for Women Entrepreneurs: Special loan schemes and training programs will be made available for women who wish to start their own business.",
      "Mentorship & Networking: Government-facilitated mentorship programs will connect young entrepreneurs with experienced business leaders and industry experts.",
    ],
  },
  {
  ...
  },
  {
    ...
    points: [
      "Multidisciplinary Schools & Colleges: Government schools and colleges will be developed as multidisciplinary institutions, offering a wide range of subjects — including Arts, Science, Commerce, Vocational, and Professional streams — under one institution, so students have more choices without needing to travel far.",
      "Dedicated Spoken English Subject & Teachers in Government Schools: Spoken English will be introduced as a separate, compulsory subject in all government schools, taught by specially appointed Spoken English teachers. This will prepare students to communicate confidently in English — essential for national and international opportunities, English proficiency tests, and global career prospects.",
      "Air-Conditioned Classrooms in Government Schools & Colleges: To create a comfortable and focused learning environment, PEP will ensure that government schools and colleges are equipped with air-conditioned classrooms. This will encourage more students and families to choose government institutions over private ones.",
      ...
      "Free government coaching centers for competitive exams: SSC (CGL, CHSL, CPO, MTS), ADRE, APSC, UPSC, JEE, NEET, CAT, and other major examinations — specifically for economically weaker and merit-based students.",
      "Government-supported Spoken English and communication training centers to help citizens succeed in national and international English tests and interactions.",
      ...
      "Free Admission & Semester Exam Fee Waiver for Economically Weaker Students in Government Colleges: PEP will provide free admission and fully waive semester examination fees for economically weaker students in government colleges. The entire cost shall be borne by the government.",
    ],
  },
  {
