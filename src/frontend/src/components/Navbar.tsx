...
export function Navbar() {
  ...
  return (
    <>
      {/* Top announcement bar with WhatsApp join link */}
      <div className="fixed top-0 left-0 right-0 z-[60] bg-[oklch(0.46_0.18_145)] py-1.5 px-4 flex items-center justify-center gap-3 text-white text-sm font-semibold">
        <SiWhatsapp size={15} />
        <span>Join the Public Ekta Party Movement —</span>
        <a
          href={WA_GROUP}
          target="_blank"
